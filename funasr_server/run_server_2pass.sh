...
online_model_dir="speech_paraformer-large_asr_nat-zh-cantonese-en-16k-vocab8501-online"
...
port=10095
certfile="0"
keyfile="/workspace/cert/server.key"
...
. /workspace/parse_options.sh || exit 1;
