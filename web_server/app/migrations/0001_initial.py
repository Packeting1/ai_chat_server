# Generated by Django 5.2.3 on 2025-08-12 10:33
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "llm_api_key",
                    models.CharField(
                        default="", max_length=200, verbose_name="LLM API密钥"
                    ),
                ),
                (
                    "llm_model",
                    models.CharField(
                        default="", max_length=100, verbose_name="LLM 模型名称"
                    ),
                ),
                (
                    "web_host",
                    models.CharField(
                        default="0.0.0.0",
                        max_length=100,
                        verbose_name="Web服务器监听地址",
                    ),
                ),
                (
                    "web_http_port",
                    models.IntegerField(default=8000, verbose_name="HTTP端口"),
                ),
                (
                    "web_https_port",
                    models.IntegerField(default=8443, verbose_name="HTTPS端口"),
                ),
                (
                    "web_ssl_enabled",
                    models.BooleanField(default=False, verbose_name="启用HTTPS/SSL"),
                ),
                (
                    "web_ssl_cert_file",
                    models.FileField(
                ...
                (
                    ...
                    models.CharField(
                        default="funasr",
                        max_length=100,
                        verbose_name="FunASR服务器地址",
                    ),
                ),
                (
                    "funasr_port",
                    models.IntegerField(default=10095, verbose_name="FunASR服务器端口"),
                ),
                (
                    "funasr_ssl",
                    models.BooleanField(default=False, verbose_name="使用SSL"),
                ),
                (
                    "funasr_ssl_verify",
                    models.BooleanField(default=False, verbose_name="验证SSL证书"),
                ),
                (
                    "use_connection_pool",
                    models.BooleanField(
                ...
                (
                    ...
                    models.IntegerField(default=2, verbose_name="连接池最小连接数"),
                ),
                (
                    "pool_max_connections",
                    models.IntegerField(default=20, verbose_name="连接池最大连接数"),
                ),
                (
                    "pool_max_idle_time",
                    models.IntegerField(
                ...
                (
                    ...
                    models.IntegerField(default=5, verbose_name="最大对话历史轮数"),
                ),
                (
                ...
                (
                    "tts_enabled",
                    models.BooleanField(default=False, verbose_name="启用TTS功能"),
                ),
                (
                    "tts_api_key",
                    models.CharField(
                        default="", max_length=200, verbose_name="DashScope API密钥"
                    ),
                ),
                (
                    "tts_model",
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="启用TTS连接池模式"),
                ),
                (
                    "tts_max_concurrent",
                    models.IntegerField(default=3, verbose_name="TTS最大并发任务数"),
                ),
                (
                    "tts_pool_max_total",
                    models.IntegerField(default=10, verbose_name="TTS连接池最大连接数"),
                ),
                (
                    "tts_connection_max_error_count",
                    models.IntegerField(default=3, verbose_name="TTS连接最大错误次数"),
                ),
                (
                    "tts_pool_min_idle",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(default=list, verbose_name="对话历史"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
