    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funasr_host', models.CharField(default='funasr', max_length=100, verbose_name='FunASR服务器地址')),
                ...
                ('tts_voice', models.CharField(default='longxiaochun_v2', max_length=50, verbose_name='TTS音色名称')),
                ...
                ('tts_max_concurrent', models.IntegerField(default=3, verbose_name='TTS最大并发任务数')),
                ('tts_pool_max_total', models.IntegerField(default=10, verbose_name='TTS连接池最大连接数')),
                ('tts_connection_max_error_count', models.IntegerField(default=3, verbose_name='TTS连接最大错误次数')),
                ('tts_pool_min_idle', models.IntegerField(default=2, verbose_name='TTS连接池最小空闲连接数')),
                ('tts_pool_max_idle', models.IntegerField(default=5, verbose_name='TTS连接池最大空闲连接数')),
                ('tts_pool_connection_timeout', models.FloatField(default=10.0, verbose_name='TTS连接超时时间（秒）')),
                ...
                ('tts_pool_max_wait_time', models.FloatField(default=30.0, verbose_name='TTS连接池最大等待时间（秒）')),
